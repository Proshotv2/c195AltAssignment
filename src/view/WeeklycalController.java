 ...
 * @author jnorr23
 */
public class WeeklycalController implements Initializable {
    ...
    public static appointment selectedAppointmentweekly;
    ...
    private void showAppointment(){
        listData = appData.getAllWeekly();
        weeklyTableview.setItems(listData);
    }
    ...
    public void editAppointment(ActionEvent event) throws IOException{
        selectedAppointmentweekly = weeklyTableview.getSelectionModel().getSelectedItem();
    ...
    */
    ...
    public void deleteappointment(ActionEvent event) throws IOException{
        ...
        appointment app = weeklyTableview.getSelectionModel().getSelectedItem();
